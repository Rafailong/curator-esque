...
util.inherits(CuratorEsque, EventEmitter)
...
function newClient (connectionString, retryCount, retryWait, connectTimeout, sessionTimeout) {
  ...
  return new CuratorEsque(connectionString, options)
}
 ...
 */
function CuratorEsque (connectionString, options) {
 ...
 * @method isConnected
 */
CuratorEsque.prototype.isConnected = function () {
 ...
 * @method getClient
 */
CuratorEsque.prototype.getClientwithConnectionCheck = function () {
 ...
 * @method getClient
 */
CuratorEsque.prototype.getClient = function () {
  return this.client
}
 ...
 * @method start
 */
CuratorEsque.prototype.start = function () {
  var self = this
 ...
 * @method close
 */
CuratorEsque.prototype.close = function () {
  this.closed = true
  this.client.close()
}
 ...
 * @method getStarted
 */
CuratorEsque.prototype.getStarted = function () {
  return this.started
}
